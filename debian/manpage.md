% kscreen-system(SECTION) | User Commands
%
% "Fri, 05 Jun 2026 12:50:54 +0200"
...
kscreen-system - program to do something

# SYNOPSIS

**kscreen-system** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**kscreen-system** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **kscreen-system** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**kscreen-system** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    kscreen-system. See **foo.conf**(5) for further details.
...
**kscreen-system** provides some return codes, that can be used in scripts:
